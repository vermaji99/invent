        ...
        <div className="form-section">
          ...
          <div className="form-grid">
            ...
            <div className="form-group">
              ...
              <input value={customer.phone} onChange={e => setCustomer({ ...customer, phone: e.target.value })} placeholder="Enter mobile number" />
            </div>
            <div className="form-group">
              <label>Email ID *</label>
              <input type="email" value={customer.email} onChange={e => setCustomer({ ...customer, email: e.target.value })} placeholder="Enter email address" />
            </div>
            <div className="form-group">
              <label>Address *</label>
              <input value={customer.address} onChange={e => setCustomer({ ...customer, address: e.target.value })} placeholder="Enter full address" />
            </div>
            <div className="form-group">
              <label>Aadhaar / Govt. ID *</label>
              <input value={customer.governmentId} onChange={e => setCustomer({ ...customer, governmentId: e.target.value })} placeholder="Enter ID number" />
            </div>
            <div className="form-group">
              ...
              <div className="file-input-wrapper">
                ...
                {customer.idProofUrl && <a href={customer.idProofUrl} className="view-link" target="_blank" rel="noreferrer">View Uploaded</a>}
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="form-section">
          ...
          <div className="form-grid">
            ...
            <div className="form-group">
              ...
              <input type="number" step="0.01" value={gold.grossWeight} onChange={e => setGold({ ...gold, grossWeight: e.target.value })} placeholder="0.00" />
            </div>
            <div className="form-group">
              <label>Net Weight (g) *</label>
              <input type="number" step="0.01" value={gold.netWeight} onChange={e => setGold({ ...gold, netWeight: e.target.value })} placeholder="0.00" />
            </div>
            <div className="form-group">
              <label>Purity *</label>
            ...
            <div className="form-group">
              ...
              <input type="number" step="0.01" value={gold.valuationAmount} onChange={e => setGold({ ...gold, valuationAmount: e.target.value })} placeholder="0.00" />
            </div>
            <div className="form-group">
              ...
              <div className="file-input-wrapper">
                ...
                {gold.itemPhotoUrl && <a href={gold.itemPhotoUrl} className="view-link" target="_blank" rel="noreferrer">View Uploaded</a>}
              </div>
            </div>
            <div className="form-group">
        ...
        <div className="form-section">
          ...
          <div className="form-grid">
            <div className="form-group">
              ...
              <input type="number" step="1" value={loan.amountGiven} onChange={e => { const v = { ...loan, amountGiven: e.target.value }; setLoan(v); recalc(); }} placeholder="0" />
            </div>
            <div className="form-group">
            ...
            <div className="form-group">
              ...
              <input type="number" step="0.01" value={loan.interestRate} onChange={e => { const v = { ...loan, interestRate: e.target.value }; setLoan(v); recalc(); }} placeholder="0.00" />
            </div>
            <div className="form-group">
            ...
            <div className="form-group">
              ...
              <input type="number" step="1" value={loan.lateExtraPerDay} onChange={e => { const v = { ...loan, lateExtraPerDay: e.target.value }; setLoan(v); recalc(); }} placeholder="0" />
            </div>
          </div>
        </div>

        <div className="pledge-card summary-card">
          <div className="summary-grid">
            <div className="summary-item">
              <span className="summary-label">Total Interest</span>
              <span className="summary-value">{formatCurrency(snapshot.totalInterest)}</span>
            </div>
            <div className="summary-item">
              <span className="summary-label">Total Payable</span>
              <span className="summary-value primary-value">{formatCurrency(snapshot.totalPayable)}</span>
            </div>
            <div className="summary-item">
              <span className="summary-label">Remaining Days</span>
              <span className="summary-value">{snapshot.remainingDays} days</span>
            </div>
          </div>
        </div>

        <div className="form-actions">
          <button type="button" className="btn-secondary" onClick={() => navigate('/pledges')}>Cancel</button>
