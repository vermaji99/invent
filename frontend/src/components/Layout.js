...
const Layout = () => {
  ...
  */
  ...
  const menuItems = [
    ...
    { path: '/old-gold', icon: FiDollarSign, label: 'Old Gold Exchange' },
    { path: '/old-gold-purchase', icon: FiPlus, label: 'Old Gold Buy' },
    { path: '/silver-purchase', icon: FiAward, label: 'Silver Buy' },
